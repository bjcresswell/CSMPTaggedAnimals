...
# Load data
Need to run the eda Rmd to get the list of all sharks
...
```{r save-silver-ab}
ggsave(filename = '../output/silvers_abacus_overview.png', silvers_ab_main , width = 600, height = 200, units = 'mm', dpi = 300)
```
