...
### MAYBE DON"T NEED THE NEXT 3 CHUNKS -> REPEATED FROM FLINHOLM SCRIPT
...
asdfasdf
## Plot VR2W locs
```{r flinders-sites, fig.width = 8, fig.height = 8}
#flinders_vr2s <- 
  flinders_base +
  ...
  geom_text(data = site_list, aes(x = station_longitude, y =station_latitude, label = station_name), size = 3) +
   annotate("text", x = 148.1, y = -17.3, label = "Flinders Reef - VR2W locations", 
